  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="bg-white border rounded-2xl shadow-sm p-6">
        <h1 className="text-3xl font-bold mb-3">Color Preview | Check Your Color Code</h1>
        <p className="text-[var(--text-secondary)]">
          Enter a HEX color code and instantly preview the color. This tool is designed to check color preview for color codes.
        </p>
      </section>
